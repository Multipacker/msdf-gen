...
#define arena_push_struct_zero(arena, type)       ((type *) arena_push_zero((arena), sizeof(type), _Alignof(type)))
#define arena_push_array_zero(arena, type, count) ((type *) arena_push_zero((arena), sizeof(type) * (count), _Alignof(type)))
